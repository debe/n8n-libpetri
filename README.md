...
*What the compiler emits. Circles are places, bars are transitions, and a token sits in a place.
...
In the gadget diagram near the top of this file, `start` acquires one `_budget` token. `run` calls
