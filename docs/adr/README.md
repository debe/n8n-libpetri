...
| [0007](0007-verification.md) | The verification surface: what the property table proves, and what it cannot | accepted |
...
All seven are accepted and none is superseded; 0004 and 0005 carry amendments recorded in the
ADR itself rather than as a new record. For what the decisions add up to — what exists, what it
is measured to do and what it deliberately does not — see
